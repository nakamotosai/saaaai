...
const FlightMapCard: React.FC = () => {
  return (
    <div className="w-full md:w-[450px] aspect-square relative rounded-[2.5rem] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.3)] border-[6px] border-white/20 bg-[#38bdf8] group cursor-default">
  ...
  return (
    <section id="about" className="relative z-20 pt-0 px-6 md:px-12 flex justify-center items-center scroll-mt-32">
      ...
      >
        ...
        <motion.div whileHover={{ y: -5 }} className="w-full md:w-auto flex-shrink-0 flex items-center justify-center">
            <FlightMapCard />
        </motion.div>
