      ...
      >
          ...
          */}
          <motion.div 
            ...
            className="absolute inset-0 rounded-full bg-gradient-to-tr from-purple-800 via-blue-800 to-cyan-800 opacity-10 blur-[100px]" 
          />
          ...
          */}
          <motion.div 
             ...
             className="absolute inset-[20%] rounded-full bg-purple-600 opacity-10 blur-[80px]" 
          />
